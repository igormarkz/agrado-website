        ...
        function (require, module, exports) {
          (function (global, factory) {
            ...
            Zoom.prototype.getModifier = function (rotateValue, axis, el) {
              ...
              var modifier = 1;
              if (axis === "X") {
                var flipHorizontalValue = Math.sign(
                ...
                var flipVerticalValue = Math.sign(
                  parseFloat(transformValues[3])
                );
                if (rotateValue === 0 || rotateValue === 180) {
                  modifier = 1;
                } else if (rotateValue === 90) {
            ...
            Zoom.prototype.getPossibleDragCords = function (
              $image,
              rotateValue
            ) {
              var minY =
            ...
            Zoom.prototype.getDragAllowedAxises = function (
              $image,
              rotateValue
            ) {
              var allowY =
              ...
              for (var i = 0; i < _this.core.___slide.length; i++) {
                ...
                utils.on(_this.core.___slide[i], "touchstart.lg", function (e) {
                  if (utils.hasClass(_this.core.outer, "lg-zoomed")) {
                    ...
                    if (allowX || allowY) {
                      e.preventDefault();
                      startCoords = _this.getSwipeCords(
                        e,
                        Math.abs(rotateValue)
                      );
                    }
                  ...
                  function (e) {
                    ...
                    if (utils.hasClass(_this.core.outer, "lg-zoomed")) {
                      if (
                        ...
                        e.preventDefault();
                        startCoords = _this.getDragCords(
                          e,
                          Math.abs(rotateValue)
                        );
